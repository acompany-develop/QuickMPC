...
func ExampleApplicationLogger_Error() {
	...
	// Output:
	// {"log_levels":"error","time_local":"2022-05-20 17:10:30 +09:00","processing_location":"Log/ApplicationLog_test.go:59","custom_message":"str1 <nil> [1 2] {1 s}","stacktrace":"github.com/acompany-develop/QuickMPC/packages/server/manage_container/Log.ExampleApplicationLogger_Error\n\t/QuickMPC/Log/ApplicationLog_test.go:59\ntesting.runExample\n\t/usr/local/go/src/testing/run_example.go:63\ntesting.runExamples\n\t/usr/local/go/src/testing/example.go:44\ntesting.(*M).Run\n\t/usr/local/go/src/testing/testing.go:1721\nmain.main\n\t_testmain.go:111\nruntime.main\n\t/usr/local/go/src/runtime/proc.go:250"}
}
...
func ExampleApplicationLogger_Errorf() {
	...
	// Output:
	// {"log_levels":"error","time_local":"2022-05-20 17:10:30 +09:00","processing_location":"Log/ApplicationLog_test.go:83","custom_message":"str 1 <nil> [1 2] {1 s}","stacktrace":"github.com/acompany-develop/QuickMPC/packages/server/manage_container/Log.ExampleApplicationLogger_Errorf\n\t/QuickMPC/Log/ApplicationLog_test.go:83\ntesting.runExample\n\t/usr/local/go/src/testing/run_example.go:63\ntesting.runExamples\n\t/usr/local/go/src/testing/example.go:44\ntesting.(*M).Run\n\t/usr/local/go/src/testing/testing.go:1721\nmain.main\n\t_testmain.go:111\nruntime.main\n\t/usr/local/go/src/runtime/proc.go:250"}
}
