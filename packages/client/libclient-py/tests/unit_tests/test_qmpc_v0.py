...
from quickmpc.qmpc_server_v0 import QMPCServer
...
class TestQMPC:
    ...
    def test_send_shares(self, params,
                         run_server4, run_server5, run_server6):
    ...
    def test_delete_shares(self, run_server4, run_server5, run_server6):
    ...
    def test_get_computation_resultRequest(self, run_server4,
                                           run_server5, run_server6):
    ...
    def test_get_data_list(self, run_server4, run_server5, run_server6):
        """ serverにシェアを送れるかのTest"""
        response: Dict[str, Any] = self.qmpc.get_data_list()
        assert (response["is_ok"])

    def test_get_job_error_info(self, run_server4, run_server5, run_server6):
        # 例外がthrowされないことをテスト
