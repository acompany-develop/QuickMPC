...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'ZDgithub.com/acompany-develop/QuickMPC/proto/LibcToManageContainer'
