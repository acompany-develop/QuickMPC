...
_ADDVALUETOIDREQUEST = DESCRIPTOR.message_types_by_name['AddValueToIdRequest']
...
AddValueToIdRequest = _reflection.GeneratedProtocolMessageType('AddValueToIdRequest', (_message.Message,), {
    'DESCRIPTOR': _ADDVALUETOIDREQUEST,
    '__module__': 'libc_to_manage_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.AddValueToIdRequest)
})
_sym_db.RegisterMessage(AddValueToIdRequest)
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    _ADDVALUETOIDREQUEST._serialized_start = 1444
    _ADDVALUETOIDREQUEST._serialized_end = 1512
    _LIBCTOMANAGE._serialized_start = 1515
    _LIBCTOMANAGE._serialized_end = 2337
