...
SendSharesRequest = _reflection.GeneratedProtocolMessageType('SendSharesRequest', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.SendSharesRequest)
})
...
DeleteSharesRequest = _reflection.GeneratedProtocolMessageType('DeleteSharesRequest', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.DeleteSharesRequest)
})
...
GetSchemaRequest = _reflection.GeneratedProtocolMessageType('GetSchemaRequest', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetSchemaRequest)
})
...
GetSchemaResponse = _reflection.GeneratedProtocolMessageType('GetSchemaResponse', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetSchemaResponse)
})
...
JoinOrder = _reflection.GeneratedProtocolMessageType('JoinOrder', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.JoinOrder)
})
...
Input = _reflection.GeneratedProtocolMessageType('Input', (_message.Message,), {
    'DESCRIPTOR': _INPUT,
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.Input)
})
...
ExecuteComputationRequest = _reflection.GeneratedProtocolMessageType('ExecuteComputationRequest', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.ExecuteComputationRequest)
})
...
ExecuteComputationResponse = _reflection.GeneratedProtocolMessageType('ExecuteComputationResponse', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.ExecuteComputationResponse)
})
...
GetComputationResultRequest = _reflection.GeneratedProtocolMessageType('GetComputationResultRequest', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetComputationResultRequest)
})
...
GetComputationResultResponse = _reflection.GeneratedProtocolMessageType('GetComputationResultResponse', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetComputationResultResponse)
})
...
GetDataListRequest = _reflection.GeneratedProtocolMessageType('GetDataListRequest', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetDataListRequest)
})
...
GetDataListResponse = _reflection.GeneratedProtocolMessageType('GetDataListResponse', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetDataListResponse)
})
...
GetElapsedTimeRequest = _reflection.GeneratedProtocolMessageType('GetElapsedTimeRequest', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetElapsedTimeRequest)
})
...
GetElapsedTimeResponse = _reflection.GeneratedProtocolMessageType('GetElapsedTimeResponse', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetElapsedTimeResponse)
})
...
GetJobErrorInfoRequest = _reflection.GeneratedProtocolMessageType('GetJobErrorInfoRequest', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetJobErrorInfoRequest)
})
...
GetJobErrorInfoResponse = _reflection.GeneratedProtocolMessageType('GetJobErrorInfoResponse', (_message.Message,), {
    ...
    '__module__': 'libc_to_manage_v0_pb2'
    # @@protoc_insertion_point(class_scope:libctomanage.v0.GetJobErrorInfoResponse)
})
...
if _descriptor._USE_C_DESCRIPTORS == False:
    ...
    DESCRIPTOR._serialized_options = b'ZFgithub.com/acompany-develop/QuickMPC/proto/libc_to_manage_container_v0'
    _SENDSHARESREQUEST._serialized_start = 107
    _SENDSHARESREQUEST._serialized_end = 275
    _DELETESHARESREQUEST._serialized_start = 277
    _DELETESHARESREQUEST._serialized_end = 330
    _GETSCHEMAREQUEST._serialized_start = 332
    _GETSCHEMAREQUEST._serialized_end = 382
    _GETSCHEMARESPONSE._serialized_start = 384
    _GETSCHEMARESPONSE._serialized_end = 444
    _JOINORDER._serialized_start = 446
    _JOINORDER._serialized_end = 503
    _INPUT._serialized_start = 505
    _INPUT._serialized_end = 541
    _EXECUTECOMPUTATIONREQUEST._serialized_start = 544
    _EXECUTECOMPUTATIONREQUEST._serialized_end = 721
    _EXECUTECOMPUTATIONRESPONSE._serialized_start = 723
    _EXECUTECOMPUTATIONRESPONSE._serialized_end = 769
    _GETCOMPUTATIONRESULTREQUEST._serialized_start = 771
    _GETCOMPUTATIONRESULTREQUEST._serialized_end = 833
    _GETCOMPUTATIONRESULTRESPONSE._serialized_start = 836
    _GETCOMPUTATIONRESULTRESPONSE._serialized_end = 1107
    _GETDATALISTREQUEST._serialized_start = 1109
    _GETDATALISTREQUEST._serialized_end = 1144
    _GETDATALISTRESPONSE._serialized_start = 1146
    _GETDATALISTRESPONSE._serialized_end = 1183
    _GETELAPSEDTIMEREQUEST._serialized_start = 1185
    _GETELAPSEDTIMEREQUEST._serialized_end = 1241
    _GETELAPSEDTIMERESPONSE._serialized_start = 1243
    _GETELAPSEDTIMERESPONSE._serialized_end = 1289
    _GETJOBERRORINFOREQUEST._serialized_start = 1291
    _GETJOBERRORINFOREQUEST._serialized_end = 1348
    _GETJOBERRORINFORESPONSE._serialized_start = 1350
    _GETJOBERRORINFORESPONSE._serialized_end = 1454
    _LIBCTOMANAGE._serialized_start = 1457
    _LIBCTOMANAGE._serialized_end = 2244
