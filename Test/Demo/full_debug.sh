...
# build処理を記述する関数
build() {
    docker buildx bake -f docker-compose.yml dev_cc1 dev_cc2 dev_cc3 dev_dbgate1 dev_sharedb1 dev_dbgate2 dev_sharedb2 dev_dbgate3 dev_sharedb3 dev_secrets-server dev_mc_envoy1 dev_mc_envoy2 dev_mc_envoy3 dev_mc1 dev_mc2 dev_mc3 --load
}
