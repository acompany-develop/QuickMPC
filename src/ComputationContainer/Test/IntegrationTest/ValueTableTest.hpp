...
const auto table1 = qmpc::ComputationToDbGate::ValueTable(table_data1, schemas1);
const auto table2 = qmpc::ComputationToDbGate::ValueTable(table_data2, schemas2);
const auto table3 = qmpc::ComputationToDbGate::ValueTable(table_data3, schemas3);
const auto table4 = qmpc::ComputationToDbGate::ValueTable(table_data4, schemas4);
const auto table5 = qmpc::ComputationToDbGate::ValueTable(table_data5, schemas5);
...
TEST(ValueTableTest, vjoinTest)
{
    ...
    const auto table_1v2 = qmpc::ComputationToDbGate::ValueTable(table_data_1v2, schemas_1v2);
    ...
    const auto table_3v4 = qmpc::ComputationToDbGate::ValueTable(table_data_3v4, schemas_3v4);
...
TEST(ValueTableTest, hjoinTest)
{
    ...
    const auto table_1h2 = qmpc::ComputationToDbGate::ValueTable(table_data_1h2, schemas_1h2);
    ...
    const auto table_3h4 = qmpc::ComputationToDbGate::ValueTable(table_data_3h4, schemas_3h4);
...
TEST(ValueTableTest, vhjoinTest)
{
    ...
    const auto table_1v2h3 = qmpc::ComputationToDbGate::ValueTable(table_data_1v2h3, schemas_1v2h3);
...
TEST(ValueTableTest, hvjoinTest)
{
    ...
    const auto table_1h2v3 = qmpc::ComputationToDbGate::ValueTable(table_data_1h2v3, schemas_1h2v3);
...
TEST(ValueTableTest, vjoinColumnTest)
{
    ...
    const auto table_1v5_2 = qmpc::ComputationToDbGate::ValueTable(table_data_1v5_2, schemas_1v5_2);
    ...
    const auto table_1v5_3 = qmpc::ComputationToDbGate::ValueTable(table_data_1v5_3, schemas_1v5_3);
...
TEST(ValueTableTest, hjoinColumnTest)
{
    ...
    const auto table_1h5_2 = qmpc::ComputationToDbGate::ValueTable(table_data_1h5_2, schemas_1h5_2);
    ...
    const auto table_1h5_3 = qmpc::ComputationToDbGate::ValueTable(table_data_1h5_3, schemas_1h5_3);
...
TEST(ValueTableTest, hjoinShareColumnTest)
{
    ...
    const auto table1_sorted1 = qmpc::ComputationToDbGate::ValueTable(table_tmp1, schemas1);
    const auto table5_sorted1 = qmpc::ComputationToDbGate::ValueTable(table_tmp5, schemas5);
    EXPECT_EQ(
    ...
    const auto table1_sorted2 = qmpc::ComputationToDbGate::ValueTable(table_tmp1, schemas1);
    const auto table5_sorted2 = qmpc::ComputationToDbGate::ValueTable(table_tmp5, schemas5);
    EXPECT_EQ(
