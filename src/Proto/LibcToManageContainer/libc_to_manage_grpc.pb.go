...
type LibcToManageClient interface {
	...
	GetComputationResult(ctx context.Context, in *GetComputationResultRequest, opts ...grpc.CallOption) (*GetComputationResultResponse, error)
...
func (c *libcToManageClient) GetComputationResult(ctx context.Context, in *GetComputationResultRequest, opts ...grpc.CallOption) (*GetComputationResultResponse, error) {
	out := new(GetComputationResultResponse)
	err := c.cc.Invoke(ctx, "/libctomanage.LibcToManage/GetComputationResult", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type LibcToManageServer interface {
	...
	GetComputationResult(context.Context, *GetComputationResultRequest) (*GetComputationResultResponse, error)
...
func (UnimplementedLibcToManageServer) GetComputationResult(context.Context, *GetComputationResultRequest) (*GetComputationResultResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetComputationResult not implemented")
}
...
func _LibcToManage_GetComputationResult_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetComputationResultRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(LibcToManageServer).GetComputationResult(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/libctomanage.LibcToManage/GetComputationResult",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibcToManageServer).GetComputationResult(ctx, req.(*GetComputationResultRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LibcToManage_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetComputationResult",
