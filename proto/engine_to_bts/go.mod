...
require (
	...
	golang.org/x/crypto v0.14.0 // NOTE: CVE-2022-27191の回避
	golang.org/x/net v0.17.0 // NOTE: CVE-2022-41717, CVE-2022-41721の回避 indirectだとCVE-2022-41717に引っかかるので決めうち
	golang.org/x/sys v0.13.0 // NOTE: CVE-2022-29526の回避
	golang.org/x/text v0.13.0 // NOTE: CVE-2020-14040, CVE-2021-38561, CVE-2022-32149の回避
