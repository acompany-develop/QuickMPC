...
require (
	...
	golang.org/x/crypto v0.21.0 // NOTE: CVE-2022-27191の回避
	golang.org/x/net v0.23.0 // NOTE: CVE-2022-41717, CVE-2022-41721の回避 indirectだとCVE-2022-41717に引っかかるので決めうち
	golang.org/x/sys v0.18.0 // NOTE: CVE-2022-29526の回避
