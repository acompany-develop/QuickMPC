...
require (
	...
	golang.org/x/net v0.9.0 // NOTE: CVE-2022-41717, CVE-2022-41721の回避 indirectだとCVE-2022-41717に引っかかるので決めうち
	golang.org/x/sys v0.7.0 // NOTE: CVE-2022-29526の回避
	golang.org/x/text v0.9.0 // NOTE: CVE-2020-14040, CVE-2021-38561, CVE-2022-32149の回避
