...
type GetRequest struct {
	...
	Type      Type   `protobuf:"varint,3,opt,name=type,proto3,enum=enginetobts.Type" json:"type,omitempty"`
...
type GetRandBitsResponse struct {
	...
	Bits []int64 `protobuf:"varint,1,rep,packed,name=bits,proto3" json:"bits,omitempty"`
}
...
func (x *GetRandBitsResponse) GetBits() []int64 {
	if x != nil {
		return x.Bits
	}
	return nil
...
var file_engine_to_bts_proto_rawDesc = []byte{
	...
	0x74, 0x73, 0x22, 0x81, 0x01, 0x0a, 0x0a, 0x47, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73,
	...
	0x2e, 0x65, 0x6e, 0x67, 0x69, 0x6e, 0x65, 0x74, 0x6f, 0x62, 0x74, 0x73, 0x2e, 0x54, 0x79, 0x70,
	...
	0x75, 0x65, 0x73, 0x74, 0x49, 0x64, 0x22, 0x32, 0x0a, 0x06, 0x54, 0x72, 0x69, 0x70, 0x6c, 0x65,
	...
	,
...
var file_engine_to_bts_proto_goTypes = []interface{}{
	...
	(*GetRequest)(nil),          // 1: enginetobts.GetRequest
...
var file_engine_to_bts_proto_depIdxs = []int32{
	0, // 0: enginetobts.GetRequest.type:type_name -> enginetobts.Type
	2, // 1: enginetobts.GetTriplesResponse.triples:type_name -> enginetobts.Triple
	1, // 2: enginetobts.EngineToBts.GetTriples:input_type -> enginetobts.GetRequest
	1, // 3: enginetobts.EngineToBts.GetRandBits:input_type -> enginetobts.GetRequest
	3, // 4: enginetobts.EngineToBts.GetTriples:output_type -> enginetobts.GetTriplesResponse
	4, // 5: enginetobts.EngineToBts.GetRandBits:output_type -> enginetobts.GetRandBitsResponse
